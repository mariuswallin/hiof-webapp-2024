...
// Setter opp route for studentController. Alle endepunkter som er definert i
// studentController vil bli lagt til under / students - layered;
app.route("/students-layered", studentController);
